...
is optional but super-useful whilst creating your layout algorithm. One stabilise, removing the debug key results in PDFs with only the items (text, graphics) to be printed.
